...
description:
      `Caller - Phone Contacts Dialer: Enhance Your Calling Experience
...
description:
`20 Testers Community is the perfect platform to connect app developers and testers, helping you get valuable feedback for your app. Secure 20 testers for 14 days, completely free, and ensure your app is ready for the Play Store.`,
    technologies: [
      "Android",
      "Kotlin",
      "Compose",
      ...
      "Coroutines",
      "Flow",
      "Retrofit","API","Firebase","Push Notifications",
    ],
  },
];
