...
import ReactJs, { Bash, Bootstrap, C, CPlusPlus, CSharp, Compose, AndroidStudio, SQLite, Rust,Flutter, ComposeMultiplatform, Ktor, CSS, Doker, DotNet, ExpressJS, FireBase, Git, GitHub, Heroku, HTML, Java, JQuery, JS, Kotlin, Kubernets, MaterialUI, MongoDB, MySQL, GraphQL, NextJs, NodeJS, PHP, PostGreSql, PostMan, Python, Redis, Redux, SASS, TailwindCSS, TS, VSCode } from "../components/SkillIcons";
...
const skills = [
    {
        ...
        style: {
            ...
            cover: "from-black to-[#B14F9780] rounded-b-md",
            opacity: "opacity-80"
        }
    },
    {
        ...
        style: {
            ...
            cover: "from-black to-[#3481d380] rounded-b-md",
            opacity: "opacity-80"
        }
    },
    {
        ...
        style: {
            ...
            cover: "from-black to-[#3DDC8480] rounded-b-md",
            opacity: "opacity-80"
        }
    },
    {
        ...
        style: {
            ...
            cover: "from-black to-[#38BF6E80] rounded-b-md",
            opacity: "opacity-80"
        }
    },
    {
        ...
        style: {
            ...
            cover: "from-black to-[#19599A80] rounded-b-md",
            opacity: "opacity-80"
    ...
    },
    {
        ...
        style: {
            ...
            cover: "from-black to-[#1266A980] rounded-b-md",
            opacity: "opacity-80"
    ...
    },
    {
        ...
        style: {
            ...
            cover: "from-black to-[#76BEE880] rounded-b-md",
            opacity: "opacity-80"
    ...
    },
    {
        ...
        style: {
            ...
            cover: "from-black to-[#d49a3580] rounded-b-md",
            opacity: "opacity-80"
    ...
    },
    {
        ...
        style: {
            ...
            cover: "from-black to-[#4FAA4180] rounded-b-md",
            opacity: "opacity-80"
        }
    },
    {
        ...
        style: {
            ...
            cover: "from-black to-[#FF6C3780] rounded-b-md",
            opacity: "opacity-80"
    ...
    },
    {
        ...
        style: {
            ...
            cover: "from-black to-[#F34F2980] rounded-b-md",
            opacity: "opacity-80"
        }
    },
    {
        ...
        style: {
            ...
            cover: "from-black to-[#5c5a5a80] rounded-b-md",
            opacity: "opacity-80"
        }
    },
    {
        ...
        style: {
            ...
            cover: "from-black to-[#9597c880] rounded-b-md",
            opacity: "opacity-80"
    ...
    },
    {
        ...
        style: {
            ...
            cover: "from-black to-[#ddbe4e80] rounded-b-md",
            opacity: "opacity-80"
    ...
    },
    {
        ...
        style: {
            ...
            cover: "from-black to-[#3949AB80] rounded-b-md",
            opacity: "opacity-80"
    ...
    },
    {
        ...
        style: {
            ...
            cover: "from-black to-[#00448280] rounded-b-md",
            opacity: "opacity-80"
        }
    },
    {
        ...
        style: {
            ...
            cover: "from-black to-[#A179DC80] rounded-b-md",
            opacity: "opacity-80"
    ...
    },
    {
        ...
        style: {
            ...
            cover: "from-black to-[#CE412B80] rounded-b-md",
            opacity: "opacity-80"
    ...
    },
    {
        ...
        style: {
            ...
            cover: "from-black to-[#F2911180] rounded-b-md",
            opacity: "opacity-80"
    ...
    },
    {
        ...
        style: {
            ...
            cover: "from-black to-[#33679180] rounded-b-md",
            opacity: "opacity-80"
    ...
    },
    {
        ...
        style: {
            ...
            cover: "from-black to-[#1D95E580] rounded-b-md",
            opacity: "opacity-80"
    ...
    },
    {
        ...
        style: {
            ...
            cover: "from-black to-[#4dbc8580] rounded-b-md",
            opacity: "opacity-80"
